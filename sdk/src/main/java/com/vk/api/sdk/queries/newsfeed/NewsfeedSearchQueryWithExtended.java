...
public class NewsfeedSearchQueryWithExtended extends AbstractQueryBuilder<NewsfeedSearchQueryWithExtended, SearchExtendedResponse> {
     ...
     */
    public NewsfeedSearchQueryWithExtended(VkApiClient client, Actor actor) {
     ...
     * @param client VK API client
     */
    public NewsfeedSearchQueryWithExtended(VkApiClient client) {
        super(client, "newsfeed.search", SearchExtendedResponse.class);
        extended(true);
    }
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public NewsfeedSearchQueryWithExtended fields(Field... value) {
