...
public class PhotoFullXtrRealOffset implements Validable {
    ...
    public PhotoFullXtrRealOffset setPhoto1280(String photo1280) {
    ...
    public PhotoFullXtrRealOffset setPhoto130(String photo130) {
    ...
    public PhotoFullXtrRealOffset setPhoto2560(String photo2560) {
    ...
    public PhotoFullXtrRealOffset setPhoto604(String photo604) {
    ...
    public PhotoFullXtrRealOffset setPhoto75(String photo75) {
    ...
    public PhotoFullXtrRealOffset setPhoto807(String photo807) {
