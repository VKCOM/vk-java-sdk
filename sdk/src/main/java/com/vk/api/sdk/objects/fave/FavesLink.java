...
public class FavesLink implements Validable {
    ...
    public FavesLink setPhoto100(String photo100) {
    ...
    public FavesLink setPhoto200(String photo200) {
    ...
    public FavesLink setPhoto50(String photo50) {
    ...
    public FavesLink setTitle(String title) {
        this.title = title;
        return this;
    }
