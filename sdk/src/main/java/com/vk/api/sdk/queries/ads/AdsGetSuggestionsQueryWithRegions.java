...
public class AdsGetSuggestionsQueryWithRegions extends AbstractQueryBuilder<AdsGetSuggestionsQueryWithRegions, List<TargSuggestionsRegions>> {
     ...
     */
    public AdsGetSuggestionsQueryWithRegions(VkApiClient client, Actor actor, String section) {
     ...
     */
    protected AdsGetSuggestionsQueryWithRegions section(String value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public AdsGetSuggestionsQueryWithRegions lang(String value) {
