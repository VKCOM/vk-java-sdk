...
public class AppMin implements Validable {
    ...
    public AppMin setAuthorId(Integer authorId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(icon139, icon75, icon278, id, type, title, authorId, icon150);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(icon278, appMin.icon278) &&
                ...
                Objects.equals(authorId, appMin.authorId) &&
