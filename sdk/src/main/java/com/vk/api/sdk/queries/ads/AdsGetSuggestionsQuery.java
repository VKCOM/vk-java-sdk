...
public class AdsGetSuggestionsQuery extends AbstractQueryBuilder<AdsGetSuggestionsQuery, List<TargSuggestions>> {
     ...
     */
    public AdsGetSuggestionsQuery(VkApiClient client, Actor actor, String section) {
     ...
     */
    protected AdsGetSuggestionsQuery section(String value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public AdsGetSuggestionsQuery lang(String value) {
