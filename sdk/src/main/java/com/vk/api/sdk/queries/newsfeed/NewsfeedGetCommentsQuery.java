...
public class NewsfeedGetCommentsQuery extends AbstractQueryBuilder<NewsfeedGetCommentsQuery, GetCommentsResponse> {
     ...
     */
    public NewsfeedGetCommentsQuery(VkApiClient client, Actor actor) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public NewsfeedGetCommentsQuery filters(String... value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public NewsfeedGetCommentsQuery fields(Field... value) {
