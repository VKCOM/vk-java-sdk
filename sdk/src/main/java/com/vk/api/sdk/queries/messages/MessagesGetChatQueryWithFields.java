...
public class MessagesGetChatQueryWithFields extends AbstractQueryBuilder<MessagesGetChatQueryWithFields, ChatFull> {
     ...
     */
    public MessagesGetChatQueryWithFields(VkApiClient client, Actor actor, Field... fields) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    protected MessagesGetChatQueryWithFields fields(Field... value) {
     ...
     * @return a reference to this {@code AbstractQueryBuilder} object to fulfill the "Builder" pattern.
     */
    public MessagesGetChatQueryWithFields nameCase(String value) {
