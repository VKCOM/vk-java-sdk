...
import com.vk.api.sdk.objects.users.UserType;
 ...
 * GetResponse object
 */
public class GetResponse extends User implements Validable {
    ...
    private GetResponseWallDefault wallDefault;

    public String getAbout() {
        return about;
    }

    public GetResponse setAbout(String about) {
        this.about = about;
        return this;
    }
    ...
    public GetResponse setAccessKey(String accessKey) {
    ...
    public GetResponse setActivities(String activities) {
    ...
    public GetResponse setActivity(String activity) {
    ...
    public GetResponse setBdate(String bdate) {
        this.bdate = bdate;
        return this;
    }
    ...
    public GetResponse setBooks(String books) {
        this.books = books;
        return this;
    }
    ...
    public GetResponse setCanBan(Boolean canBan) {
        this.canBan = canBan;
        return this;
    }
    ...
    public GetResponse setCanBeInvitedGroup(Boolean canBeInvitedGroup) {
    ...
    public GetResponse setCanCall(Boolean canCall) {
    ...
    public GetResponse setCanCallFromGroup(Boolean canCallFromGroup) {
    ...
    public GetResponse setCanSeeWishes(Boolean canSeeWishes) {
    ...
    public GetResponse setCanSubscribePodcasts(Boolean canSubscribePodcasts) {
    ...
    public GetResponse setCanSubscribePosts(Boolean canSubscribePosts) {
    ...
    public GetResponse setCareer(List<Career> career) {
        this.career = career;
        return this;
    }
    ...
    public GetResponse setCity(City city) {
        this.city = city;
        return this;
    }
    ...
    public GetResponse setClipsCount(Integer clipsCount) {
    ...
    public GetResponse setCommonCount(Integer commonCount) {
    ...
    public GetResponse setContactId(Integer contactId) {
    ...
    public GetResponse setContactName(String contactName) {
    ...
    public GetResponse setCounters(UserCounters counters) {
    ...
    public GetResponse setCountry(Country country) {
    ...
    public GetResponse setCropPhoto(CropPhoto cropPhoto) {
    ...
    public GetResponse setDescriptions(List<String> descriptions) {
    ...
    public GetResponse setDomain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public GetResponse setEducationForm(String educationForm) {
    ...
    public GetResponse setEducationStatus(String educationStatus) {
    ...
    public GetResponse setEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public GetResponse setExports(Exports exports) {
    ...
    public GetResponse setFacebook(String facebook) {
    ...
    public GetResponse setFacebookName(String facebookName) {
    ...
    public GetResponse setFaculty(Integer faculty) {
    ...
    public GetResponse setFacultyName(String facultyName) {
    ...
    public GetResponse setFirstNameAbl(String firstNameAbl) {
    ...
    public GetResponse setFirstNameAcc(String firstNameAcc) {
    ...
    public GetResponse setFirstNameDat(String firstNameDat) {
    ...
    public GetResponse setFirstNameGen(String firstNameGen) {
    ...
    public GetResponse setFirstNameIns(String firstNameIns) {
    ...
    public GetResponse setFirstNameNom(String firstNameNom) {
    ...
    public GetResponse setFollowersCount(Integer followersCount) {
    ...
    public GetResponse setGames(String games) {
        this.games = games;
        return this;
    }
    ...
    public GetResponse setGraduation(Integer graduation) {
    ...
    public GetResponse setHasUnseenStories(Boolean hasUnseenStories) {
    ...
    public GetResponse setHash(String hash) {
        this.hash = hash;
        return this;
    }
    ...
    public GetResponse setHomePhone(String homePhone) {
    ...
    public GetResponse setHomeTown(String homeTown) {
    ...
    public GetResponse setInstagram(String instagram) {
    ...
    public GetResponse setInterests(String interests) {
    ...
    public GetResponse setIsBestFriend(Boolean isBestFriend) {
    ...
    public GetResponse setIsMessageRequest(Boolean isMessageRequest) {
    ...
    public GetResponse setIsNoIndex(Boolean isNoIndex) {
    ...
    public GetResponse setIsService(Boolean isService) {
    ...
    public GetResponse setIsSubscribedPodcasts(Boolean isSubscribedPodcasts) {
    ...
    public GetResponse setLanguage(String language) {
    ...
    public GetResponse setLastNameAbl(String lastNameAbl) {
    ...
    public GetResponse setLastNameAcc(String lastNameAcc) {
    ...
    public GetResponse setLastNameDat(String lastNameDat) {
    ...
    public GetResponse setLastNameGen(String lastNameGen) {
    ...
    public GetResponse setLastNameIns(String lastNameIns) {
    ...
    public GetResponse setLastNameNom(String lastNameNom) {
    ...
    public GetResponse setLastSeen(LastSeen lastSeen) {
    ...
    public GetResponse setLists(List<Integer> lists) {
        this.lists = lists;
        return this;
    }
    ...
    public GetResponse setLivejournal(String livejournal) {
    ...
    public GetResponse setMaidenName(String maidenName) {
    ...
    public GetResponse setMilitary(List<Military> military) {
    ...
    public GetResponse setMobilePhone(String mobilePhone) {
    ...
    public GetResponse setMovies(String movies) {
        this.movies = movies;
        return this;
    }
    ...
    public GetResponse setMusic(String music) {
        this.music = music;
        return this;
    }
    ...
    public GetResponse setNickname(String nickname) {
    ...
    public GetResponse setOccupation(Occupation occupation) {
    ...
    public GetResponse setOwnerState(State ownerState) {
    ...
    public GetResponse setPersonal(Personal personal) {
    ...
    public GetResponse setPhoto200(URI photo200) {
    ...
    public GetResponse setPhoto200Orig(URI photo200Orig) {
    ...
    public GetResponse setPhoto400(String photo400) {
    ...
    public GetResponse setPhoto400Orig(URI photo400Orig) {
    ...
    public GetResponse setPhotoBig(String photoBig) {
    ...
    public GetResponse setPhotoId(String photoId) {
    ...
    public GetResponse setPhotoMax(URI photoMax) {
    ...
    public GetResponse setPhotoMaxOrig(URI photoMaxOrig) {
    ...
    public GetResponse setPhotoMaxSize(Photo photoMaxSize) {
    ...
    public GetResponse setPhotoMedium(JsonPrimitive photoMedium) {
    ...
    public GetResponse setPhotoMediumRec(JsonPrimitive photoMediumRec) {
    ...
    public GetResponse setPhotoRec(JsonPrimitive photoRec) {
    ...
    public GetResponse setQuotes(String quotes) {
        this.quotes = quotes;
        return this;
    }
    ...
    public GetResponse setRelation(UserRelation relation) {
    ...
    public GetResponse setRelationPartner(UserMin relationPartner) {
    ...
    public GetResponse setRelatives(List<Relative> relatives) {
    ...
    public GetResponse setSchools(List<School> schools) {
    ...
    public GetResponse setServiceDescription(String serviceDescription) {
    ...
    public GetResponse setSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetResponse setSkype(String skype) {
        this.skype = skype;
        return this;
    }
    ...
    public GetResponse setStatusApp(AppMin statusApp) {
    ...
    public GetResponse setStatusAudio(Audio statusAudio) {
    ...
    public GetResponse setStoriesArchiveCount(Integer storiesArchiveCount) {
    ...
    public GetResponse setTimezone(Number timezone) {
    ...
    public GetResponse setTv(String tv) {
        this.tv = tv;
        return this;
    }
    ...
    public GetResponse setTwitter(String twitter) {
    ...
    public GetResponse setType(UserType type) {
        this.type = type;
        return this;
    }
    ...
    public GetResponse setUniversities(List<University> universities) {
    ...
    public GetResponse setUniversity(Integer university) {
    ...
    public GetResponse setUniversityGroupId(Integer universityGroupId) {
    ...
    public GetResponse setUniversityName(String universityName) {
    ...
    public GetResponse setVideoLive(LiveInfo videoLive) {
    ...
    public GetResponse setVideoLiveCount(Integer videoLiveCount) {
    ...
    public GetResponse setVideoLiveLevel(Integer videoLiveLevel) {
    ...
    public GetResponseWallDefault getWallDefault() {
        return wallDefault;
    }

    public GetResponse setWallDefault(GetResponseWallDefault wallDefault) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(canCall, getResponse.canCall) &&
                Objects.equals(career, getResponse.career) &&
                Objects.equals(universityGroupId, getResponse.universityGroupId) &&
                Objects.equals(occupation, getResponse.occupation) &&
                Objects.equals(about, getResponse.about) &&
                Objects.equals(hasUnseenStories, getResponse.hasUnseenStories) &&
                Objects.equals(photoBig, getResponse.photoBig) &&
                Objects.equals(instagram, getResponse.instagram) &&
                Objects.equals(type, getResponse.type) &&
                Objects.equals(statusAudio, getResponse.statusAudio) &&
                Objects.equals(quotes, getResponse.quotes) &&
                Objects.equals(relation, getResponse.relation) &&
                Objects.equals(isService, getResponse.isService) &&
                Objects.equals(movies, getResponse.movies) &&
                Objects.equals(firstNameGen, getResponse.firstNameGen) &&
                Objects.equals(relationPartner, getResponse.relationPartner) &&
                Objects.equals(storiesArchiveCount, getResponse.storiesArchiveCount) &&
                Objects.equals(twitter, getResponse.twitter) &&
                Objects.equals(music, getResponse.music) &&
                Objects.equals(photoMaxSize, getResponse.photoMaxSize) &&
                Objects.equals(universities, getResponse.universities) &&
                Objects.equals(graduation, getResponse.graduation) &&
                Objects.equals(games, getResponse.games) &&
                Objects.equals(lastNameNom, getResponse.lastNameNom) &&
                Objects.equals(canCallFromGroup, getResponse.canCallFromGroup) &&
                Objects.equals(canSeeAllPosts, getResponse.canSeeAllPosts) &&
                Objects.equals(canSeeWishes, getResponse.canSeeWishes) &&
                Objects.equals(commonCount, getResponse.commonCount) &&
                Objects.equals(counters, getResponse.counters) &&
                Objects.equals(firstNameAcc, getResponse.firstNameAcc) &&
                Objects.equals(personal, getResponse.personal) &&
                Objects.equals(photoMediumRec, getResponse.photoMediumRec) &&
                Objects.equals(books, getResponse.books) &&
                Objects.equals(isSubscribedPodcasts, getResponse.isSubscribedPodcasts) &&
                Objects.equals(schools, getResponse.schools) &&
                Objects.equals(domain, getResponse.domain) &&
                Objects.equals(firstNameAbl, getResponse.firstNameAbl) &&
                Objects.equals(hash, getResponse.hash) &&
                Objects.equals(status, getResponse.status) &&
                Objects.equals(hasMobile, getResponse.hasMobile) &&
                Objects.equals(activity, getResponse.activity) &&
                Objects.equals(photoId, getResponse.photoId) &&
                Objects.equals(city, getResponse.city) &&
                Objects.equals(canSeeGifts, getResponse.canSeeGifts) &&
                Objects.equals(hasPhoto, getResponse.hasPhoto) &&
                Objects.equals(skype, getResponse.skype) &&
                Objects.equals(nickname, getResponse.nickname) &&
                Objects.equals(photo200, getResponse.photo200) &&
                Objects.equals(email, getResponse.email) &&
                Objects.equals(contactName, getResponse.contactName) &&
                Objects.equals(isVideoLiveNotificationsBlocked, getResponse.isVideoLiveNotificationsBlocked) &&
                Objects.equals(facebook, getResponse.facebook) &&
                Objects.equals(photo, getResponse.photo) &&
                Objects.equals(educationStatus, getResponse.educationStatus) &&
                Objects.equals(photoMedium, getResponse.photoMedium) &&
                Objects.equals(blacklisted, getResponse.blacklisted) &&
                Objects.equals(site, getResponse.site) &&
                Objects.equals(wallDefault, getResponse.wallDefault) &&
                Objects.equals(cropPhoto, getResponse.cropPhoto) &&
                Objects.equals(lastNameIns, getResponse.lastNameIns) &&
                Objects.equals(photoRec, getResponse.photoRec) &&
                Objects.equals(interests, getResponse.interests) &&
                Objects.equals(isFriend, getResponse.isFriend) &&
                Objects.equals(country, getResponse.country) &&
                Objects.equals(tv, getResponse.tv) &&
                Objects.equals(bdate, getResponse.bdate) &&
                Objects.equals(canSendFriendRequest, getResponse.canSendFriendRequest) &&
                Objects.equals(lastSeen, getResponse.lastSeen) &&
                Objects.equals(blacklistedByMe, getResponse.blacklistedByMe) &&
                Objects.equals(language, getResponse.language) &&
                Objects.equals(descriptions, getResponse.descriptions) &&
                Objects.equals(educationForm, getResponse.educationForm) &&
                Objects.equals(faculty, getResponse.faculty) &&
                Objects.equals(canSubscribePodcasts, getResponse.canSubscribePodcasts) &&
                Objects.equals(isNoIndex, getResponse.isNoIndex) &&
                Objects.equals(statusApp, getResponse.statusApp) &&
                Objects.equals(military, getResponse.military) &&
                Objects.equals(lastNameGen, getResponse.lastNameGen) &&
                Objects.equals(firstNameNom, getResponse.firstNameNom) &&
                Objects.equals(homePhone, getResponse.homePhone) &&
                Objects.equals(test, getResponse.test) &&
                Objects.equals(videoLiveCount, getResponse.videoLiveCount) &&
                Objects.equals(livejournal, getResponse.livejournal) &&
                Objects.equals(isMessageRequest, getResponse.isMessageRequest) &&
                Objects.equals(relatives, getResponse.relatives) &&
                Objects.equals(photoMax, getResponse.photoMax) &&
                Objects.equals(canSeeAudio, getResponse.canSeeAudio) &&
                Objects.equals(firstNameIns, getResponse.firstNameIns) &&
                Objects.equals(homeTown, getResponse.homeTown) &&
                Objects.equals(lists, getResponse.lists) &&
                Objects.equals(canBeInvitedGroup, getResponse.canBeInvitedGroup) &&
                Objects.equals(ownerState, getResponse.ownerState) &&
                Objects.equals(videoLive, getResponse.videoLive) &&
                Objects.equals(photo200Orig, getResponse.photo200Orig) &&
                Objects.equals(photo400Orig, getResponse.photo400Orig) &&
                Objects.equals(clipsCount, getResponse.clipsCount) &&
                Objects.equals(isFavorite, getResponse.isFavorite) &&
                Objects.equals(exports, getResponse.exports) &&
                Objects.equals(isBestFriend, getResponse.isBestFriend) &&
                Objects.equals(timezone, getResponse.timezone) &&
                Objects.equals(university, getResponse.university) &&
                Objects.equals(canSubscribePosts, getResponse.canSubscribePosts) &&
                Objects.equals(firstNameDat, getResponse.firstNameDat) &&
                Objects.equals(contactId, getResponse.contactId) &&
                Objects.equals(facultyName, getResponse.facultyName) &&
                Objects.equals(photoMaxOrig, getResponse.photoMaxOrig) &&
                Objects.equals(lastNameDat, getResponse.lastNameDat) &&
                Objects.equals(mobilePhone, getResponse.mobilePhone) &&
                Objects.equals(isHiddenFromFeed, getResponse.isHiddenFromFeed) &&
                Objects.equals(canPost, getResponse.canPost) &&
                Objects.equals(photo400, getResponse.photo400) &&
                Objects.equals(maidenName, getResponse.maidenName) &&
                Objects.equals(serviceDescription, getResponse.serviceDescription) &&
                Objects.equals(wallComments, getResponse.wallComments) &&
                Objects.equals(canBan, getResponse.canBan) &&
                Objects.equals(videoLiveLevel, getResponse.videoLiveLevel) &&
                Objects.equals(universityName, getResponse.universityName) &&
                Objects.equals(canUploadDoc, getResponse.canUploadDoc) &&
                Objects.equals(lastNameAcc, getResponse.lastNameAcc) &&
                Objects.equals(canWritePrivateMessage, getResponse.canWritePrivateMessage) &&
                Objects.equals(activities, getResponse.activities) &&
                Objects.equals(accessKey, getResponse.accessKey) &&
                Objects.equals(followersCount, getResponse.followersCount) &&
                Objects.equals(facebookName, getResponse.facebookName) &&
                Objects.equals(lastNameAbl, getResponse.lastNameAbl);
    }
